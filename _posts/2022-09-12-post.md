...
## untitled subheading
<figure><a href="{{site.url}}/assets/focusstyle.png"><img src="{{site.url}}/assets/focusstyle.png" alt="Screenshot of an unread Gmail message from Zell Liew, titled “Designing a focus style” and dated to October 2nd, 2019."/></a><figcaption>Alas, I still use Gmail.</figcaption></figure>
...
And sure, picture's worth a thousand words, even utilitarian images [can be captioned differently depending how they're used](https://www.upyoura11y.com/images-icons-and-emojis/).
...
<figure><a href="{{site.url}}/assets/prompt-engineer.png"><img src="{{site.url}}/assets/prompt-engineer.png" alt="Screenshot of a diagram in the video; context described below."/></a></figure>
